...
public class wREQed {
    ...
    public static void main(String[] args) {
        ...
        Person.pickMurderer();
        Location.chooseMurderLocation();
        Location.investigate(Gym);
        Location.investigate(Location.murderLocation);  
        Person.Interrogate(Person.murderer.friend);
        Person.Interrogate(JJ);
        Location.investigate(Location.currentInvolvedLocation);
        Location.investigate(Edge);
        Person.Interrogate(Person.currentPersonInvolved1);
        Person.Accuse(Person.murderer);
        ...
        Location.chooseMurderLocation();
        Location.investigate(Location.murderLocation);
        Person.Interrogate(Louis);
        Person.Interrogate(Person.murderer.enemiedBy);
        Location.investigate(Location.currentInvolvedLocation);
        Person.Interrogate(Rafa);
        Person.timeSkip();
